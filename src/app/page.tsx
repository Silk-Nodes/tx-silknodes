...
import WalletGovernance from "@/components/WalletGovernance";
        ...
        {activeTab === "portfolio" && (
          <>
            ...
            {portfolioTab === "wallet" && (
              wallet.connected ? (
                <>
                  {/* Manage first: this tab exists to act on the wallet.
                      PSE history is a record and reads last. The first
                      version led with the history because it was the newest
                      thing built, which is not a hierarchy. */}
                  <div className="pt-scope">
                    <span className="pt-scope-label">Your wallet</span>
