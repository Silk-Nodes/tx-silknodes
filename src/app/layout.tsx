    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta
          ...
          content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://*.clarity.ms; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; frame-src https://restake.app; connect-src 'self' https://api.coingecko.com https://api.silknodes.io https://coreum-lcd.silknodes.io https://coreum-rpc.silknodes.io https://rest-coreum.ecostake.com https://rpc-coreum.ecostake.com wss://rpc-coreum.ecostake.com https://full-node.mainnet-1.coreum.dev:1317 https://full-node.mainnet-1.coreum.dev:26657 https://api.mainnet-1.tx.org https://hasura.mainnet-1.coreum.dev https://api.web3forms.com https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://*.clarity.ms; object-src 'none'; base-uri 'self';"
        />
